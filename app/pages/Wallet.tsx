...
export default function Wallet() {
  return (
    <View style={walletStyles.container}>
      ...
      <View style={[walletStyles.transactionItem, walletStyles.transaction_sent]}>
        <Ionicons
      ...
      <View style={[walletStyles.transactionItem, walletStyles.transaction_received]}>
        <Ionicons
        ...
        />
        <View style={{ flex: 1 }}>
          <Text style={walletStyles.transactionLabel}>Received from Lisa</Text>
          <Text style={walletStyles.transactionDate}>2025-08-03</Text>
        </View>
        <Text style={walletStyles.transactionAmount}>+ R 100.00</Text>
      </View>

      <View style={[walletStyles.transactionItem, walletStyles.transaction_bill]}>
        <Ionicons
      ...
      <View style={[walletStyles.transactionItem, walletStyles.transaction_topup]}>
        <Ionicons
